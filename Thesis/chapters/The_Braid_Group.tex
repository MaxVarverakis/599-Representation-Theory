...
\begin{figure}[htbp]
    ...
    \caption{The action of $\sigma_i$ on the generators $x_i$ and $x_{i+1}$ as described by \cref{eq:rho_i,eq:rho_ip1,eq:rho_j}.}\label{fig:sigma_on_Dn}
\end{figure}
...
\end{align}
These relations can be verified graphically as in \cref{fig:sigma_on_x_i}.
\begin{figure}[htbp]
    \centering
