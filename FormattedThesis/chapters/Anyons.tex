...
Now that we have established the braid group (representations) in a physical context, we can investigate the consequences of nontrivial braiding effects on a system of anyons, starting with the simplest nontrivial example of two non-interacting anyons.
